...
describe('Exercícios de fixação', () => {
  ...
  it('Mudar a cor do texto para verde caso o email seja válido', () => {
    const EMAIL_USER = 'email@email.com';
  ...
  it('Mudar a cor do texto para vermelho caso o email seja inválido', () => {
    const EMAIL_USER2 = 'emailerrado';

    render(<ValidEmail email={EMAIL_USER2} />);
    const isValidText2 = screen.getByTestId('id-is-email-valid');
    expect(isValidText2).toHaveAttribute('class', 'red-text')
  });
});
